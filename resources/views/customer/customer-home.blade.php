                 ...
                 <div class="col-lg-6">
                     <div class="row product-style-1">
                         <div class="col-lg-12 m-b30 wow fadeInUp" data-wow-delay="0.2s">
                             <div class="product-box style-2"
                                 style="background-image: url('images/shop/product2.png');">
                                 <div class="product-content">
                                     <div class="main-content">
                         ...
                         <div class="col-lg-12 wow fadeInUp" data-wow-delay="0.3s">
                             <div class="product-box style-3"
                                 style="background-image: url('images/shop/product3.png');">
                                 <div class="product-content">
                                     <div class="main-content">
             ...
             <div class="row product-style2 g-0">
                 <div class="col-lg-6 col-md-6 p-b30 wow fadeInUp" data-wow-delay="0.1s">
                     <div class="product-box style-4"
                         style="background-image: url('images/shop/large/product1.png');">
                         <div class="product-content">
                             <div class="main-content">
                 ...
                 <div class="col-lg-6 col-md-6 p-t30 wow fadeInUp" data-wow-delay="0.2s">
                     <div class="product-box style-4"
                         style="background-image: url('images/shop/large/product2.png');">
                         <div class="product-content">
                             <div class="main-content">
                                             ...
                                             <div class="swiper-slide">
                                                 <div class="dz-media DZoomImage">
                                                     <a class="mfp-link lg-item"
                                                         href="images/products/baby-seat.png"
                                 ...
                                 <div class="dz-content">
                                     ...
                                     <div class="btn-group cart-btn">
                                         <a href="shop-cart.html"
                                             class="btn btn-md btn-secondary text-uppercase">Add
                                             To Cart</a>
